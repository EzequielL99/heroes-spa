...
const numberAsPercentage = (number: number): number => (number / 10) * 100;
        ...
        <Card className="group overflow-hidden hover:shadow-xl transition-all duration-300 hover:-translate-y-1 bg-gradient-to-br from-white to-gray-50">
            <div className="relative h-64">
                <img
                    src={hero.image}
                    alt={hero.name}
                    className="object-cover cursor-pointer transition-all duration-500 w-full absolute top-[-30px] h-[410px] group-hover:scale-110"
                    onClick={handleClick}
                />

                {/* Status indicator */}
                <div className="absolute top-3 left-3 flex items-center gap-2">
                    <div className={`w-3 h-3 rounded-full ${hero.status.toLowerCase() === 'active' ? 'bg-green-500' : 'bg-red-500'}`} />
            ...
            <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                    <div className="space-y-1">
                        ...
                        <Progress value={numberAsPercentage(hero.strength)} className="h-2" activeColor='bg-orange-500' />
                    </div>
                    <div className="space-y-1">
                        <div className="flex items-center gap-1">
                        ...
                        <Progress value={numberAsPercentage(hero.intelligence)} className="h-2" activeColor='bg-blue-500' />
                    </div>
                    <div className="space-y-1">
                        <div className="flex items-center gap-1">
                        ...
                        <Progress value={numberAsPercentage(hero.speed)} className="h-2" activeColor='bg-green-500' />
                    </div>
                    <div className="space-y-1">
                        <div className="flex items-center gap-1">
                        ...
                        <Progress value={numberAsPercentage(hero.durability)} className="h-2" activeColor='bg-purple-500' />
                    </div>
                </div>
