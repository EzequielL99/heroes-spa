                ...
                <div className="max-w-7xl mx-auto px-6 py-12">
                    <div className="flex flex-col md:flex-row items-center gap-8">
                        <div className="relative">
                            <div className="rounded-full border-4 bord border-white/20 shadow-2xl w-[250px] h-[250px] overflow-hidden">
                                <img
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            ...
                            <Card className="text-center">
                                <CardContent className="pt-6">
                                    ...
                                    <Progress value={superheroData ? superheroData.strength * 10 : 0} className="h-2" />
                                </CardContent>
                            </Card>
                            ...
                            <Card className="text-center">
                                <CardContent className="pt-6">
                                    ...
                                    <Progress value={superheroData ? superheroData.intelligence * 10 : 0} className="h-2" />
                                </CardContent>
                            </Card>
                            ...
                            <Card className="text-center">
                                <CardContent className="pt-6">
                                    ...
                                    <Progress value={superheroData ? superheroData.speed * 10 : 0} className="h-2" />
                                </CardContent>
                            </Card>
                            ...
                            <Card className="text-center">
                                <CardContent className="pt-6">
                                    ...
                                    <Progress value={superheroData ? superheroData.durability * 10 : 0} className="h-2" />
                                </CardContent>
                            </Card>
                        </div>
                                ...
                                <div className="space-y-4">
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="flex-1">
                                            <Progress value={superheroData ? superheroData.strength * 10 : 0} className="h-4" />
                                        </div>
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="flex-1">
                                            <Progress value={superheroData ? superheroData.intelligence * 10 : 0} className="h-4" />
                                        </div>
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="flex-1">
                                            <Progress value={superheroData ? superheroData.speed * 10 : 0} className="h-4" />
                                        </div>
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="flex-1">
                                            <Progress value={superheroData ? superheroData.durability * 10 : 0} className="h-4" />
                                        </div>
